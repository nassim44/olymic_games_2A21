...
void admin::on_pushButton_clicked()//boutton gestion des stades
{
    QString USERNAME=ui->lineEdit_username->text();
    QString PASSWORD=ui->lineEdit_password->text();
...
void admin::on_pushButton_4_clicked()//boutton gestion des joueurs
{
    QString USERNAME=ui->lineEdit_username->text();
    QString PASSWORD=ui->lineEdit_password->text();
    if((USERNAME=="SAHAR")&&(PASSWORD=="2222"))
    {
        GJ=new Gestion_des_joueurs(this);
        GJ->show();
    }
}
