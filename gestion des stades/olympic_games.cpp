...
QSqlQueryModel* olympic_games::wombo_combo()
{
    ...
    QSqlQueryModel* model=new QSqlQueryModel();
    model->setQuery("select TYPE_JEUX from OLYMPIC_GAMES");
    return model;
}
//-------------rechercher --------ID-JEUX-----------------------------
...
//---------------------------CHERCHER SELON LE DISCIPLINE---------------------------------------------------------------------------------------
  ...
  QSqlQueryModel* olympic_games::getidj()
  {

      QSqlQueryModel* model=new QSqlQueryModel();

      model->setQuery("SELECT ID_JEUX FROM OLYMPIC_GAMES");
      model->setHeaderData(0,Qt::Horizontal, QObject::tr("Identifiant"));
      return model;
  }

//  olympic_games* olympic_games::getjeux(int id)
//  {
//      QSqlQuery query;
//      query.prepare("SELECT * FROM olympic_games WHERE ID_JEUX = :id");
//      query.bindValue(":id",id);
//      query.exec();
//      olympic_games* j = new olympic_games();
//      while (query.next()) {
